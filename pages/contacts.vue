    ...
    <div class="page-container py-16">
      <div class="grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div class="space-y-6">
            <!-- Телефон -->
            <div class="flex items-start gap-4 p-5 bg-white rounded-sm shadow-sm border border-cream-300/50">
              <div class="w-11 h-11 rounded-sm bg-gold/10 flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <div class="font-body text-xs text-brown-400 font-semibold tracking-wide uppercase mb-1">Телефон</div>
                <a href="tel:+77001234567" class="font-body text-sm text-brown-900 font-medium hover:text-gold transition-colors">+7 (700) 123-45-67</a>
              </div>
            </div>
            <!-- Email -->
            <div class="flex items-start gap-4 p-5 bg-white rounded-sm shadow-sm border border-cream-300/50">
              ...
              <div>
                <div class="font-body text-xs text-brown-400 font-semibold tracking-wide uppercase mb-1">Email</div>
                <a href="mailto:info@dverlux.kz" class="font-body text-sm text-brown-900 font-medium hover:text-gold transition-colors">info@dverlux.kz</a>
              </div>
            </div>
            <!-- Адрес -->
            <div class="flex items-start gap-4 p-5 bg-white rounded-sm shadow-sm border border-cream-300/50">
              ...
              <div>
                <div class="font-body text-xs text-brown-400 font-semibold tracking-wide uppercase mb-1">Адрес</div>
                <p class="font-body text-sm text-brown-900 font-medium leading-relaxed">г. Алматы, ул. Абая, 100<br>ТЦ «ДомТорг», 2 этаж</p>
              </div>
            </div>
            <!-- Режим работы -->
            <div class="flex items-start gap-4 p-5 bg-white rounded-sm shadow-sm border border-cream-300/50">
              ...
              <div>
                <div class="font-body text-xs text-brown-400 font-semibold tracking-wide uppercase mb-1">Режим работы</div>
                <p class="font-body text-sm text-brown-900 font-medium leading-relaxed">Пн–Пт: 9:00–19:00<br>Сб: 10:00–17:00<br>Вс: выходной</p>
              </div>
            </div>
          </div>
