...
useHead({
  title: "Контакты — ЭталонЛюкс",
  meta: [
    {
      name: "description",
      content:
        "Контакты магазина ЭталонЛюкс в Астана. Адрес, телефон, режим работы. Задайте вопрос онлайн.",
    },
    { property: "og:title", content: "Контакты — ЭталонЛюкс" },
  ],
});
